        ...
        <main v-else class="page-list">
            <div class="list-container">
                ...
                <p v-if="ii = 0 == 12">you shouldn't see this</p>
                    ...
                    <template v-else-if="fpsAsked != null && level.password.split('/').map(s => s.match(/\d+/)?.[0]).filter(Boolean).some(pwd => fpsAsked.includes(pwd)) && engineAsked == null">
                            <td class="rank">
                    ...
                    <template v-else-if="fpsAsked != null && engineAsked != null && level.password.split('/').map(s => s.trim()).some(pwd => engineAsked.includes(pwd)) && engineAsked != null && level.password.split('/').map(s => s.match(/\d+/)?.[0]).filter(Boolean).some(pwd => fpsAsked.includes(pwd))">
                            <td class="rank">
                                <p v-if="i + 1 <= 350" class="type-label-lg">#{{ ii = ii + 1 }} (#{{ i + 1 }})</p>
                                <p v-else class="type-label-lg">Legacy</p>
                            </td>
            ...
            <div class="level-container">
                <div class="level" v-if="level">
					...
					<form action="#" class="type-label-lg">
                    	...
                    	<input type="text" class="btn" v-model="fpsSelected" id="fps" name="fps" placeholder="Enter FPS value">
                        <p>
                        <br>
